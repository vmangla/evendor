...
public final class FBReader extends Activity {
	...
	static boolean myBookFilter;
	
	static String bookPathForTestingTobeRemove;
	
	Context context;
	
	public static int width;
	public static int height;
	public static boolean isOnlyForFirstCover = true;

	public static void openBookActivity(Context context, Book book, Bookmark bookmark) {
		
		Toast.makeText(context, "BOOK OPENED", Toast.LENGTH_LONG).show();
...
public static void openBookActivityMy(Context context, Book book, Bookmark bookmark,boolean yes,String bookPath) {
		
	bookPathForTestingTobeRemove = bookPath;
		myBookFilter = yes;
	...
	private synchronized void openBook(Intent intent, Runnable action, boolean force) {
		...
		// My Code to read Book
		
		//String baseDir = Environment.getExternalStorageDirectory().getAbsolutePath();
	    //  String path  = baseDir + "/Books/" + "998905797b8646fd44134910d1f88c33.epub";
		
		//String path = Uri.parse("file:///android_asset/Crash.epub").toString();
		
				
		//String path  = "file:///android_asset/Crash.epub" ;
		myBook = createBookForFile(ZLFile.createFileByPath(bookPathForTestingTobeRemove));
	...
	//	new ZLAndroidLibrary(getApplication()).setActivity(this);
