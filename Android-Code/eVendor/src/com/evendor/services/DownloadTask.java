...
import com.evendor.error.FileAlreadyExistException;
import com.evendor.error.NoMemoryException;
import com.evendor.http.AndroidHttpClient;
...
//    String bookDescription,String bookUrl,String bookId,String bookPath,String bookAuthor,String bookPublisherName,String bookPublishedDate,String bookSize,
//    String bookCategory   
    ...
    public DownloadTask(Context context, String url, String path ,String iconPath ,String bookTitle,String bookPrice
    		,String bookDescription,String bookUrl,String bookId,
    		String bookPath,String bookAuthor,String bookPublisherName,
    		String bookPublishedDate,String bookSize,String bookCategory,
    		String file_name, String priceText,String country_id) throws MalformedURLException {

        this(context, url, path, null , iconPath , bookTitle , bookPrice, bookDescription, bookUrl, bookId, 
        		bookPath, bookAuthor, bookPublisherName, bookPublishedDate, bookSize, bookCategory,file_name,priceText,country_id);
    }

    public DownloadTask(Context context, String url, String path, DownloadTaskListener listener, 
    		String iconPath, String bookTitle,String bookPrice,
    		String bookDescription,String bookUrl,String bookId,String bookPath,
    		String bookAuthor,String bookPublisherName,String bookPublishedDate,String bookSize,
    		String bookCategory,String file_name, String priceText,String country_id)
        ...
        if(file_name.contains(".pdf")){
         fileName = new File(URL.getFile()).getName() + ".pdf";
        }else{
        	 fileName = new File(URL.getFile()).getName() + ".epub";	
        }
        ...
        setBookPublishedDate(bookPublishedDate);
