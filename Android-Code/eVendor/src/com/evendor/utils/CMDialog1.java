...
public class CMDialog1 extends Dialog 
{

	public static final String REGISTER_TITLE = "Register new account";
	public static final String ACCEPT = "Accept the Terms";
	...
	public CMDialog1(Context context) 
	{
		super(context);
		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
		this.setContentView(R.layout.cm_dialog1);
