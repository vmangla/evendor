...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if(savedInstanceState!=null){
			if(savedInstanceState.containsKey("BookName"))
	...
	public void createUI(Bundle savedInstanceState) {
		...
		try{
			/**@author MIPC27
			 * changed the process of book rendering 
			 */
			if(!BookName.equals("")){
				mFilenameView.setText(BookName);
			}else{
			String temp_name = mFileName.substring(0, mFileName.lastIndexOf("."));
			// Set the file-name text
			mFilenameView.setText(temp_name);
			}
		}catch(Exception E){
