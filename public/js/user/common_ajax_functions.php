...
{
	result="<ul class=\"shortcut-buttons-set\"><?php if(in_array("0", $dataModules)) {?><li><a class=\"shortcut-button\" href=\"<?php echo $this->url(array('module'=>'company','controller'=>'profile','action'=>'index'),'',true);?>\" title=\"My Profile\" onclick=\"return goToPage(this.href,'tab4');\"><span><img src=\"<?php echo $this->serverUrl().$this->baseUrl();?>/public/css/company/images/staffe.png\" alt=\"My Profile\"><br>My Profile</span></a></li><?php } ?><?php if(in_array("0", $dataModules)) {?><li><a class=\"shortcut-button\" href=\"<?php echo $this->url(array('module'=>'company','controller'=>'profile','action'=>'updateprofile'),'',true);?>\" title=\"Update Profile\" onclick=\"return goToPage(this.href,'tab4');\"><span><img src=\"<?php echo $this->serverUrl().$this->baseUrl();?>/public/css/company/images/update_profile.png\" alt=\"Update Profile\"><br>Update Profile</span></a></li><?php } ?><?php if(in_array("0", $dataModules)) {?><li><a class=\"shortcut-button\" href=\"<?php echo $this->url(array('module'=>'company','controller'=>'profile','action'=>'changepassword'),'',true);?>\" title=\"Password Setting\" onclick=\"return goToPage(this.href,'tab4');\"><span><img src=\"<?php echo $this->serverUrl().$this->baseUrl();?>/public/css/company/images/advancedsettings.png\" alt=\"Settings\" ><br>Settings</span></a></li><?php } ?></ul>";
