...
- (id)initWithFrame:(CGRect)frame title:(NSString *)title
{
	...
	if ((self = [super initWithFrame:frame]))
	{
        ...
        doneButton.frame = CGRectMake(viewWidth-10-DONE_BUTTON_WIDTH, BUTTON_Y, DONE_BUTTON_WIDTH, BUTTON_HEIGHT);
		//[doneButton setTitle:NSLocalizedString(@"Done", @"button") forState:UIControlStateNormal];
        [doneButton setTitle:NSLocalizedString(@"Exit", @"button") forState:UIControlStateNormal];
