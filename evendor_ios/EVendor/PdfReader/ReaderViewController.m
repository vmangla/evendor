...
- (void)viewDidLoad
{
	...
	self.view.backgroundColor = [UIColor groupTableViewBackgroundColor];//[UIColor scrollViewTexturedBackgroundColor];
    
	CGRect viewRect = self.view.bounds; // View controller's view bounds
    
    CGRect tempRect = CGRectMake(viewRect.origin.x, viewRect.origin.y+44, viewRect.size.width, viewRect.size.height-44);
    
	theScrollView = [[ReaderScrollView alloc] initWithFrame:tempRect]; // All
	...
	NSString *toolbarTitle = (self.bookTitle == nil) ? [document.fileName stringByDeletingPathExtension] : self.bookTitle ;
