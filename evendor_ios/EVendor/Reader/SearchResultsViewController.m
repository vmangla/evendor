...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (![results count]) {
        cell.textLabel.text = [NSString stringWithFormat:@"No result found!"];
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"Chapter %d", hit.chapterIndex];
...
//    NSLog(@"w:%f h:%f", webView.bounds.size.width, webView.bounds.size.height);
    ...
    NSString *foundHits = [webView stringByEvaluatingJavaScriptFromString: @"document.documentElement.innerHTML"];
