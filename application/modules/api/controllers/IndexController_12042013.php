		...
		if(is_array($formData))
		{
           	...
           	switch($jsonObj->apicall)
			{
				...
				case "GetLibrary":
					...
					{
						$sql="SELECT prod.*, storeprice.product_id, storeprice.country_id, storeprice.language_id, storeprice.price FROM pclive_products as prod INNER JOIN pclive_product_prices as storeprice ON prod.id=storeprice.product_id WHERE prod.admin_approve='1' AND storeprice.country_id='$jsonObj->StoreId' ORDER BY prod.cat_id ASC";
					}
					else
					{
						$sql="SELECT prod.*, storeprice.product_id, storeprice.country_id, storeprice.language_id, storeprice.price FROM pclive_products as prod INNER JOIN pclive_product_prices as storeprice ON prod.id = storeprice.product_id WHERE prod.admin_approve='1' ORDER BY prod.cat_id ASC";
					}
