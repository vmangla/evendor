<?php //define("GOOGLE_API_KEY", "AIzaSyAyPsey2kHDELsWzyC0UD7aNIAgkCoGKp4"); 
//define("GOOGLE_API_KEY", "AIzaSyDWb3ekRmAbHMycQl3964fmbCc6vgfleyE"); 
//define("GOOGLE_API_KEY", "AIzaSyAD9wG3keWSiwbfwKbkt3UZExNCCz4Dmbc"); 
							...
							*/	
							...
							/*if(@in_array($Parray['id'],$array_of_books))
								...
								//{
									...
									{
										$sql_issue = "select *,chd.subscription_type as subs_type,chd.group_id as grp_id,chd.start_date as start_date,chd.publication_id as publication_id from  pclive_credit_history as ch,pclive_user_sub_details chd where ch.order_id=chd.order_id and publication_id='".$result_product_pub[0]['parent_brand_id']."' and chd.user_id='".$jsonObj->UserId."' and ch.payment_status='1'";
									...
									else
									{
										...
										$query_pur_book = "select *,chd.subscription_type as subs_type,chd.group_id as grp_id,chd.start_date as start_date,chd.publication_id as publication_id from  pclive_credit_history as ch,pclive_user_sub_details chd where ch.order_id=chd.order_id and chd.product_id='".$Parray['product_id']."' and chd.user_id='".$jsonObj->UserId."' and ch.payment_status='1'";
