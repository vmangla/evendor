				...
				case "UserUpdate":
					...
					{	
						...
						else 
						{
							...
							$sql = "UPDATE pclive_companies SET first_name='$jsonObj->FirstName', last_name='$jsonObj->LastName', country='$jsonObj->Country',account_type='$jsonObj->Acounttype'  where id='$jsonObj->id'";
...
WHERE replace( country, ' ', '' ) = '".$countrrep."' ";
							...
							$sql = "UPDATE pclive_companies SET first_name='$jsonObj->FirstName', last_name='$jsonObj->LastName', country='".$data_country[0]['id']."',account_type='$jsonObj->Acounttype'  where id='$jsonObj->id'";
