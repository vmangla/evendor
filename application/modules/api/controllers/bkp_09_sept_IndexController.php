					...
					$records = $result->FetchAll();
				     	...
				     	if(count($records)>0)
						{
							...
							*/
								...
								$response['Library'][$key]['ProductThumbnail']=$thumbnail_path;
								$response['Library'][$key]['Producturl']="http://www.miprojects2.com.php53-6.ord1-1.websitetestlink.com/projects/evendor/api/download/index/apicall/Bookdownload/apikey/".$jsonObj->apikey."/bookid/".$Parray['product_id']."/bookname/".$bookname;
					...
					$records = $result->FetchAll();
				     	...
				     	if(count($records)>0)
						{
							...
							*/	
								...
								$response['groupBooks'][$key]['Producturl']="http://www.miprojects2.com.php53-6.ord1-1.websitetestlink.com/projects/evendor/api/download/index/apicall/Bookdownload/apikey/".$jsonObj->apikey."/bookid/".$Parray['product_id']."/bookname/".$bookname;
