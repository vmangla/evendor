...
class Company_RegisterController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
        ...
        if($this->getRequest()->isPost())
		{
			...
			{
				$formErrors['city']="Please enter phone";
			}
			...
			{
				$formErrors['c_phone']="Please enter phone";
			}
			...
			*/			
			...
			if(count($formErrors)==0)
			{
				...
				$company_pwd = md5($formData['user_password']);
				$companyData=array(
								'name'=>$formData['name'],										
			...
			{
				 $this->view->errorMessage = '<div class="div-error">Please enter required field to register.</div>';
			}      
        }
