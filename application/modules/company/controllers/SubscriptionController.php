...
class Company_SubscriptionController extends Zend_Controller_Action
{
	...
	public function manageAction()
	{
		...
		if(isset($_POST['subscription_type']) && $_POST['subscription_type']=='0')
		{
			$whrcls.=" and subscription_type=0";
		}
		if(isset($_POST['subscription_type']) && $_POST['subscription_type']=='1')
		{
			$whrcls.=" and subscription_type>0";
		}
		if(isset($_POST['subscription_name']) && $_POST['subscription_name']!='')
		{
			$whrcls.=" and subscription_name='".$_POST['subscription_name']."'";
		}
		 
		$MySubscriptionsList=$this->modelUserSubscription->getGroupSubscriptionList($this->sessCompanyInfo->id,$whrcls); 
	...
	public function viewmembersAction()
	{
		...
		$subscription_type=$this->_request->getParam('subscription_type',0);
		
		$userdata = $this->modelUserSubscription->fetchAll('order_id='.$orderid.' and group_id='.$group_id.' and subscription_type='.$subscription_type.'');
		echo '<table>';
