...
class Publisher_BookController extends Zend_Controller_Action
{
	...
	public function updateproductpriceAction()
	{
		...
		$createpriceURL = "http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor/publisher/book/addprice/";
...
<td>
   <div align="left">
    <a href="http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor/publisher/book/deleteprice/id/<?php echo $priceList[$jj]['id'];?>" onclick="return deleteprice(this.href)" title="delete">
			<img src="http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor/public/css/publisher/images/trash.gif" width="10" height="10"/>
			</a>
			<a href="javascript:void(0);" onclick="return updateprice1('<?php echo $priceList[$jj]['id'];?>','http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor//publisher/book/saveprice','<?php echo $_REQUEST['productid'];?>');">
			<img src="http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor/public/css/publisher/images/icon_edit.png" width="10" height="10"/>
			</a>
...
?>
	...
	?>	
	  <form name="form-add-price" id="form-add-price" method="post" onsubmit="return updateprice1('<?php echo $_POST['priceid'];?>','http://www.miprojects.com.php53-16.ord1-1.websitetestlink.com/projects/evendor/publisher/book/updateproductprice/productid/<?php echo $_POST['productid'];?>','<?php echo $_POST['productid'];?>');">
	  <fieldset class="dashboard_fieldset">
			<legend>Publication Store & Langauge</legend>
	  		<table width="99%"  class="table-list publisher"  border="0" cellspacing="0" cellpadding="0">
				<tr>
...
echo "</table>";
    ...
    {	
		...
		if(($FileType=="application/octet-stream" || $FileType=="application/epub" || $FileType=="application/pdf" || $FileType=="application/epub+zip" || $FileType=="application/x-zip-compressed") && $_FILES['ImageEFile']['error']==0)
		{
			//Get file extension from Image name, this will be re-added after random name
				...
				$titleBrandDropdown=$this->modelBooks->getTitleBrandList('',$this->parentPublisherId,$post_data['cat_id']);
				 ...
				 //echo "Count brand : - ".$titleBrandDropdown."<br>";
					...
					if(strtolower(trim($cat_info['category_name']))==strtolower(trim('Magazine')) || strtolower(trim($cat_info['category_name']))==strtolower(trim('Magazines')))
					{
						...
						$isbn_field='<input type="text" name="isbn_number" id="isbn_number" value=""  class="req issn"  message="Please enter issn number" invalidmessage="Please enter a valid ISSN number format." maxlength="13" /><br /><br />';
						$isbn_field='<input type="text" name="isbn_number" id="isbn_number" value=""  class="req issn"  message="Please enter issn number" invalidmessage="Please enter a valid ISSN number format." maxlength="13"/><br /><br />';
					}
