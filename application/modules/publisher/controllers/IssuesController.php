...
<td>
   <div align="left">
    <a href="http://miprojects2.com.php53-6.ord1-1.websitetestlink.com/projects/evendor/publisher/issues/deleteprice/id/<?php echo $priceList[$jj]['id'];?>" onclick="return deleteprice(this.href)" title="delete">
			...
			<a href="javascript:void(0);" onclick="return updateprice1('<?php echo $priceList[$jj]['id'];?>','http://miprojects2.com.php53-6.ord1-1.websitetestlink.com/projects/evendor/publisher/issues/saveprice','<?php echo $_REQUEST['productid'];?>');">
...
?>
	...
	?>	
	  <form name="form-add-price" id="form-add-price" method="post" onsubmit="return updateprice1('<?php echo $_POST['priceid'];?>','http://miprojects2.com.php53-6.ord1-1.websitetestlink.com/projects/evendor/publisher/issues/updateproductprice/productid/<?php echo $_POST['productid'];?>','<?php echo $_POST['productid'];?>');">
	  <fieldset class="dashboard_fieldset">
			<legend>Publication Store & Langauge</legend>
	  		<table width="99%"  class="table-list publisher"  border="0" cellspacing="0" cellpadding="0">
				<tr>
