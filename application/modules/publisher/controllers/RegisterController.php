	...
	public function indexAction()
	{
        ...
        if($this->getRequest()->isPost())
		{
			...
			*/
			...
			{
				$formErrors['name']="Please enter publishing company name.";
			}
			...
			if(!(isset($formData['c_phone'])) || trim($formData['c_phone'])=="")
			{
				$formErrors['c_phone']="Please enter contact phone number.";
			}
			...
			if($this->modelPublisher->isExist('emailid="'.$formData['emailid'].'" and parent_id="0"') || $this->modelCompany->isExist('user_email="'.$formData['emailid'].'"'))
			{
				if(!(array_key_exists('emailid',$formErrors)))
				{
