	...
	public function createAction()
	{
		...
		if($this->getRequest()->isPost() && (!empty($formData['createbook']) && $formData['createbook']=='Add Book'))
		{
			...
			{ 
					...
					if(isset($formData['issn_number']) && !empty($formData['issn_number']))
					{
					...
					if(isset($formData['issn_number']) && !empty($formData['issn_number']) &&  $this->modelBooks->isExist("isbn_number='$formData[issn_number]'"))
					{
						if(!(array_key_exists('issn_number',$formErrors)))
						{
