...
class Publisher_Model_DbTable_Books extends Zend_Db_Table
{
	...
	public function isGroupPriceExist($productID,$countryID,$languageID,$grouppriceval)
	{
		$retVal=false;
	...
	{   
		$retVal=array();  
		$select='SELECT * from '.$this->_name.' where product_type="'.$genreid.'" and status=1 and admin_approve=1';
		$retVal=$this->getAdapter()->FetchAll($select); 
		return $retVal;
	}
