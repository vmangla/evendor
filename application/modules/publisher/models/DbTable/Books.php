...
class Publisher_Model_DbTable_Books extends Zend_Db_Table
{
	...
	/*********This Function is made to show the list of publications in frontend due to same function use in admin as well*************/
	public function getListFront($publisher_id,$where="")
	{
		$list=array();
	...
	/*********Ends This Function is made to show the list of publications in frontend due to same function use in admin as well*************/
	...
	public function getkeywordlist($keyword,$storeid,$languageid,$genreid)
	{
		...
		$query->where('up.image_name!=""'); 
		
		$query->where('p.file_name!= ""');
	...
	/*****************My function**********************/
	public function getgenrelistFront($storeid,$languageid,$genreid)
	{
		$list=array();
	...
	/******This function is made due to same funciton call in admin as well**********/
	public function getPublicationIdsByCategoryNameFront($storeId,$cat_Name,$admin_Approve=1,$is_Featured=0,$parentBrandID=0,$product_id=0)
	{
		...
		$query->where('prodimage.image_name!=""'); 
	...
	/******Ends this function is made due to same funciton call in admin as well**********/
	...
	/*******************Function for search publication start here for frontend *************************/
	
	public function getPublicationIdsByCategoryNameCountFront($storeId,$cat_Name,$admin_Approve=1,$is_Featured=0,$parentBrandID=0,$product_id=0)
	{
	...
	/*******************Function for search publication start here for frontend ends here *************************/
	...
	/******************My Function**************/
	public function getStorePublicationDetailFront($productID,$storeId,$languageID,$is_Featured=0)
	{
		$list=array();
	...
	/************Home page function for featured items**************/
	public function getPublicationFeaturedItemFront($storeId,$cat_Name,$admin_Approve=1,$is_Featured=0)
	{
	...
	/************Ends Home page function for featured items**************/
	...
	/**************My Function********************/
	public function getBestSellerProductFront($storeId,$cate_id,$status,$admin_approve=1)
	{
		$query=$this->select();
		$query->setIntegrityCheck(false);
		$query->from(array("prod"=>$this->_name),array("prod.*"));
	...
	public function getBackIssueFront($storeId,$parent_brand_id)
	{
	...
	/********************My function*****************************/
	public function getPublicationListByStoreFront($storeId,$admin_Approve=1)
	{
	...
	public function getPublicationListByGenreFront($genreId,$storeId='',$admin_Approve=1)
	{
	...
	/**********************function for home page right side***********************/
	public function getPublicationListByGenreByStoreFront($genreId,$storeId,$admin_Approve=1,$cat_id='')
	{
	...
	/**********************function for home page right side ends here*************/
	...
	{
		$retVal=array();  
		$select='SELECT p.*,sum(p.no_download) as tot_down,Cr.credit_id,Cr.userid,Cr.price,sum(Cr.quantity*Cr.price) as tot_price,Cr.price as cr_price,sum(Cr.quantity) as quantity,Cr.store_id,Cr.subscription_type,Cr.subscription_name,Cr.add_date,Cr.group_id,trh.purchaseAmount,trh.currency from '.$this->_name.' as p LEFT JOIN '.$this->_credit_history.' as Cr ON p.id=Cr.bookid LEFT JOIN '.$this->_transaction_history.' as trh ON Cr.transaction_id=trh.id where publisher_id="'.$publisher_id.'" group by Cr.bookid order by Cr.credit_id desc';
		$retVal=$this->getAdapter()->fetchAll($select); 
		return $retVal;
	}
