...
class Publisher_Model_DbTable_Books extends Zend_Db_Table
{
	...
	public function getAllStores()
	{
		...
		$store_query="SELECT GROUP_CONCAT(country,'%^') as country_names, GROUP_CONCAT(id,'%^') as country_ids, continent_id FROM ".$this->_countryname." WHERE id<>0 and status=1 GROUP BY continent_id ORDER BY country_names DESC";
